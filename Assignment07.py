...
#   MDKemery, 2024.08.10, created script
#   MDKemery, 2024.08.10, write Person/Student classes
#   MDKemery, 2024.08.11, connect Person/Student classes to rest of program
#   MDKemery, 2024.08.13, general debugging / fixing
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    """
    A class to represent a person data
    Properties:
        first_name: str
        last_name: str
    changeLog:
        - mdkemery 2024.08.10: create class
    """
...
class Student(Person):
    """
    A class to represent a student data - inheriting from Person class
    Properties:
    ...
    # todo fix data validation since it is okay if the course name includes numeric values.
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str, student_data: list):
        ...
        MDkemery,2024.08.11, connected function to student object and student class
        ...
        """
        try:
            file = open(file_name, 'r') # create file object
            list_of_dictionary_data = json.load(file) ## read in contents of file
    ...
    def write_data_to_file(file_name: str, student_data: list):
        ...
        ChangeLog: (Who, When, What)
        RRoot,1.1.2030,Created function
        MDKemery, 2024.08.11, updated function to deal with student class
        ...
        try:
            ...
            #json.dump(student_data, file,index=4)
...
class IO:
    ...
    def input_student_data(student_data: list):
        ...
        ChangeLog: (Who, When, What)
        RRoot,1.1.2030,Created function
        MDK, 2024.08.13, updated from dict to student class for data storage
        ...
        try:
            student_first_name = input("Enter the student's first name: ").strip() #using strip method to remove excess spaces
